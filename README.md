...
Composability. Multiple extend-writes can be chained. Each produces a diff and the sequence of diffs constitutes a complete version history of the knowledge lattice. This enables temporal navigation: the system can revert to any prior state by undoing diffs in reverse order.
